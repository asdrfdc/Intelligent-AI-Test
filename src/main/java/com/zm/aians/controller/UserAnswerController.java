...
import com.zm.aians.annotation.AuthCheck;
import com.zm.aians.common.BaseResponse;
import com.zm.aians.common.DeleteRequest;
import com.zm.aians.common.ErrorCode;
import com.zm.aians.common.ResultUtils;
import com.zm.aians.constant.UserConstant;
import com.zm.aians.exception.BusinessException;
import com.zm.aians.exception.ThrowUtils;
import com.zm.aians.model.dto.useranswer.UserAnswerAddRequest;
import com.zm.aians.model.dto.useranswer.UserAnswerEditRequest;
import com.zm.aians.model.dto.useranswer.UserAnswerQueryRequest;
import com.zm.aians.model.dto.useranswer.UserAnswerUpdateRequest;
import com.zm.aians.model.entity.App;
import com.zm.aians.model.entity.User;
import com.zm.aians.model.entity.UserAnswer;
import com.zm.aians.model.enums.ReviewStatusEnum;
import com.zm.aians.model.vo.UserAnswerVO;
import com.zm.aians.scoring.ScoringStrategyExecutor;
import com.zm.aians.service.AppService;
import com.zm.aians.service.UserAnswerService;
import com.zm.aians.service.UserService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if(!ReviewStatusEnum.PASS.equals(ReviewStatusEnum.getEnumByValue(oldApp.getReviewStatus()))){
            throw new BusinessException(ErrorCode.OPERATION_ERROR,"应用未通过审核，无法答题");
        }
        //  填充默认值
        ...
        //调用评分模块
        try {
            UserAnswer userAnswerWithResult = scoringStrategyExecutor.doScore(choices, oldApp);
