...
import com.zm.aians.manager.AiManager;
import com.zm.aians.model.dto.question.*;
...
public class QuestionController {
    ...
    private String getGenerateQuestionUserMessagg(App app,int questionNumber,int optionNumber){
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        //封装Prompt
        String userMessage = getGenerateQuestionUserMessagg(app, questionNumber, optionNumber);
        //AI 生成
    ...
    public SseEmitter aiGenerateQuestionSSE(
        ...
        //左括号计数器，除了默认值外，当回归0时，表示左括号等于右括号，可以截取
        ...
        modelDataFlowable
                ...
                .doOnComplete(sseEmitter::complete)  //告诉前端已完成，必写
                .subscribe();
        return sseEmitter;
    }
